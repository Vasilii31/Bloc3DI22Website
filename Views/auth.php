...
<body>
                ...
                <div class="form-wrapper">
                    <div class="card">
                        ...
                        <div class="card-body" id="formContainer">
                            <form method="POST" action="../Back/processUser.php" id="loginForm">
                            ...
                            <form method="POST" action="../Back/processUser.php" id="registerForm" class="toggleForm">
    ...
    <script src="../jsScripts/authentification.js"></script>
</body>
</html>

            ...
            <div class="football_player_content_subsection" id="my_team">
                ...
                <?php 
                    foreach($myPlayers as $myPlayer)
                    {
                        ...
                        //Modify the player//
                        echo "<button class='myTeamButton'><a href='../Views/Trainer_Add_Player.php?UpdateIdJoueur=".$myPlayer['IdJoueur']."'>Modifier</a></button> ";
                        //Delete the player//
                        echo "<button class='myTeamButton'><a href='../Views/myTeam.php?DeleteIdJoueur=".$myPlayer['IdJoueur']."'>Supprimer</a></button> </br></br>";
                    }
                ?>
                <button class='myTeamButton'><a href="../Views/Trainer_Add_Player.php">Ajouter un Joueur</a></button>
            </div>
        </div>


    </div>
    <script src="../scriptsJs/acceuilPreConnexion.js"></script>
</body>
